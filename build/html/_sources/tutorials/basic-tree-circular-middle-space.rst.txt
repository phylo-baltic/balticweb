...
.. image:: ../_static/tutorials/basic-tree-circular-middle-space.png
   :alt: basic-tree-circular-middle-space
   :class: example-detail__hero-img

.. raw:: html

   <p class="example-detail__source-link">
     <a href="../_static/tutorials/basic-tree-circular-middle-space.py" download>Download python source</a>
   </p>
