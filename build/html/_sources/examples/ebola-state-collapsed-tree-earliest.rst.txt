state collapsed tree earliest
=============================

.. image:: ../_static/examples/ebola/state-collapsed-tree-earliest.png
   :alt: state-collapsed-tree-earliest
   :class: example-detail__hero-img

.. raw:: html

   <p class="example-detail__source-link">
     <a href="../_static/examples/ebola/state-collapsed-tree-earliest.py" download>Download python source</a>
   </p>
