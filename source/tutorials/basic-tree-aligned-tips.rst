...
.. image:: ../_static/tutorials/basic-tree-aligned-tips.png
   :alt: basic-tree-aligned-tips
   :class: example-detail__hero-img

.. raw:: html

   <p class="example-detail__source-link">
     <a href="../_static/tutorials/basic-tree-aligned-tips.py" download>Download python source</a>
   </p>
