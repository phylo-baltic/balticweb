...
.. image:: ../_static/tutorials/basic-tree-collapse.png
   :alt: basic-tree-collapse
   :class: example-detail__hero-img

.. raw:: html

   <p class="example-detail__source-link">
     <a href="../_static/tutorials/basic-tree-collapse.py" download>Download python source</a>
   </p>
