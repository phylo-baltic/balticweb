...
.. image:: ../_static/tutorials/basic-tree-circular-inward.png
   :alt: basic-tree-circular-inward
   :class: example-detail__hero-img

.. raw:: html

   <p class="example-detail__source-link">
     <a href="../_static/tutorials/basic-tree-circular-inward.py" download>Download python source</a>
   </p>
