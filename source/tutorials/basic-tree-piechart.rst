...
.. image:: ../_static/tutorials/basic-tree-piechart.png
   :alt: basic-tree-piechart
   :class: example-detail__hero-img

.. raw:: html

   <p class="example-detail__source-link">
     <a href="../_static/tutorials/basic-tree-piechart.py" download>Download python source</a>
   </p>
