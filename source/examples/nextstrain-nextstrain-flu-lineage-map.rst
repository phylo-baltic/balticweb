nextstrain flu lineage map
==========================

.. image:: ../_static/examples/nextstrain/nextstrain-flu-lineage-map.png
   :alt: nextstrain-flu-lineage-map
   :class: example-detail__hero-img

.. raw:: html

   <p class="example-detail__source-link">
     <a href="../_static/examples/nextstrain/nextstrain-flu-lineage-map.py" download>Download python source</a>
   </p>
