...
This page contains example analyses and visualizations built with baltic.
Each section groups examples by dataset/topic.

.. raw:: html

   <section class="examples-section">
     <h2 class="examples-section__title">Ebola</h2>
     <div class="gallery-grid">
       <a class="gallery-card" href="ebola-exploded-tree-high-level.html">
   ...
   <section class="examples-section">
     <h2 class="examples-section__title">Influenza-B-virus</h2>
     <div class="gallery-grid">
       <a class="gallery-card" href="influenza-b-virus-tangled-chain.html">
     <div class="gallery-card__imgwrap">
   ...
   <section class="examples-section">
     <h2 class="examples-section__title">MERS-CoV</h2>
     <div class="gallery-grid">
       <a class="gallery-card" href="mers-cov-exploded-tree-high-level.html">
     <div class="gallery-card__imgwrap">
   ...
   <section class="examples-section">
     <h2 class="examples-section__title">nextstrain</h2>
     <div class="gallery-grid">
       <a class="gallery-card" href="nextstrain-auspice-json-io.html">
     <div class="gallery-card__imgwrap">
   ...
   <section class="examples-section">
     <h2 class="examples-section__title">samogitia</h2>
     <div class="gallery-grid">
       <a class="gallery-card" href="samogitia-samogitia-ebola-custom.html">
     <div class="gallery-card__imgwrap">
   ...
   <section class="examples-section">
     <h2 class="examples-section__title">SARS-CoV-2</h2>
     <div class="gallery-grid">
       <a class="gallery-card" href="sars-cov-2-muller-plot-abstract.html">
     <div class="gallery-card__imgwrap">
   ...
   <section class="examples-section">
     <h2 class="examples-section__title">WuMV-6</h2>
     <div class="gallery-grid">
       <a class="gallery-card" href="wumv-6-map-tree.html">
     <div class="gallery-card__imgwrap">
   ...
   <section class="examples-section">
     <h2 class="examples-section__title">Zika-virus</h2>
     <div class="gallery-grid">
       <a class="gallery-card" href="zika-virus-root-to-tip.html">
     <div class="gallery-card__imgwrap">
...
.. toctree::
   ...
   ebola-exploded-tree-high-level
   ebola-exploded-tree-low-level
   ebola-height-95hpd-bars
   ebola-simple-tree
   ebola-state-collapsed-tree-earliest-adjust
   ...
   mers-cov-height-95hpd-bars
   mers-cov-homoplasy-tree
   mers-cov-pad-nodes
   mers-cov-reduced-tree-camel
   mers-cov-reduced-tree-human
   mers-cov-simple-tree
   mers-cov-skygrid-calendar-time
