samogitia ebola custom
======================

.. image:: ../_static/examples/samogitia/samogitia-ebola-custom.png
   :alt: samogitia-ebola-custom
   :class: example-detail__hero-img

.. raw:: html

   <p class="example-detail__source-link">
     <a href="../_static/examples/samogitia/samogitia-ebola-custom.py" download>Download python source</a>
   </p>
